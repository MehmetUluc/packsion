          ...
          <div class="box-body">
			...
			<div class="col-md-12">
				<div class="ibox">
					...
					<?php if($quiz_o->gender == 'woman'): ?>
						<tr>
							<th style="width:30%;">Cinsiyet:</th>
							<td><?php echo $quiz_o->gender ?></td>
						</tr>
						<tr>
							<th>Doğum Tarihi:</th>
						...
						<tr>
							...
							<td><img src='/images/<?php echo $folder. "/" . $quiz->vucut; ?>.jpg' width="120"  />
						...
						<tr>
							...
							<div style="float:left; text-align:center">
								<img src="/images/<?php echo $folder . '/tshirt/' . $stil; ?>.jpg" width="120"/>
								<br /><?php echo isset($stil) ? ucwords($stil) : ''; ?></div>
								<?php endforeach ?>
							</td>
						</tr>
						...
						<tr>
							...
							<div style="float:left; text-align:center">
								<img src="/images/<?php echo $folder . '/etek/' . $stil; ?>.jpg" width="120" />
								<br /><?php echo isset($stil) ? ucwords($stil) : ''; ?></div>
								<?php endforeach ?>
					...
					<?php else: ?>
						<tr>
							<th style="width:30%;">Cinsiyet:</th>
							<td><?php echo isset($quiz_o->gender) ? $quiz_o->gender : ''; ?></td>
						</tr>
						<tr>
							<th>Doğum Tarihi:</th>
							<td><?php echo isset($quiz->dob) ? $quiz->dob : ''; ?></td>
