    ...
    <div class="holidaySlideHero-module-wrapper">
      ...
      <div class="holidaySlideHero-module">
        <div class="inner">
                                    ...
                                    <h2><?php echo e(@trans('woman.lets_build')); ?></h2>
          <p>
              <?php echo e(@trans('woman.is_shopping')); ?> 
                      

          <div class="module-cta">
                          <a href="/checkout/quiz/step/1?gender=woman&cache=flush" class="button--rounded button--eq-width"><?php echo e(@trans('woman.get_started')); ?></a>
...
<section id="how-it-works" class="u-posRelative timeline-container" data-behavior="HowItWorks">
  <div class="u-container u-marginAuto u-textCenter">
    <div class="u-md-size2of3 u-marginAuto">
      <h2 class="u-marginBs"><?php echo e(@trans('woman.how_works')); ?></h2>
      <h4 class="u-textSans"><?php echo e(@trans('woman.getting_your_first')); ?></h4>
    </div>
    ...
    <div class="u-marginTxl u-paddingTm u-posRelative">
        ...
        <div class="js-progressBar u-posAbsolute"></div>
          ...
          <div class="center-vertical isChrome-mobile">
            ...
            <div class="u-hidden video-transcript">
              <p>
                <?php echo e(@trans('woman.paragraph_1')); ?>
      ...
      <div class="how-it-works-video-placeholder">
        <div class="how-it-works-inner u-textCenter u-vertCenter">
          ...
          <p class="u-textSans"><?php echo e(@trans('woman.see')); ?></p>
      ...
      <ol class="timeline Grid u-md-sizeFull u-sm-size3of4 u-marginAuto">
        ...
        <li class="Grid-cell timeline-module u-md-size1of2 u-posRelative">
          <div class="u-boxShadow">
            ...
            <div class="timeline-module__content u-textCenter u-paddingAl u-bg-color--white">
              <p class="u-fontWeight--bold"><?php echo e(@trans('woman.create_style')); ?></p>
              <span class="u-block u-marginTs u-marginBm u-divider"></span>
              <p>
                <span class="u-md-hide"><?php echo e(@trans('woman.by_answering')); ?>!</span>
                <span class="u-md-show"><?php echo e(@trans('woman.where_you_shop')); ?>.</span>
              </p>
            </div>
          </div>
        </li>
        ...
        <li class="Grid-cell timeline-module u-md-size1of2 u-posRelative">
          <div class="u-boxShadow">
            ...
            <div class="timeline-module__content u-textCenter u-paddingAl u-bg-color--white">
              <p class="u-fontWeight--bold"><?php echo e(@trans('woman.chat_with_stylist')); ?></p>
              <span class="u-block u-marginTs u-marginBm u-divider"></span>
              <p>
                <span class="u-md-hide"><?php echo e(@trans('woman.youll_talk_to')); ?></span>
                <span class="u-md-show"><?php echo e(@trans('woman.yes_a_real')); ?></span>
              </p>
            </div>
          </div>
        </li>
        ...
        <li class="Grid-cell timeline-module u-md-size1of2 u-posRelative">
          <div class="u-boxShadow">
            ...
            <div class="timeline-module__content u-textCenter u-paddingAl u-bg-color--white">
              <p class="u-fontWeight--bold"><?php echo e(@trans('woman.review_trunk')); ?></p>
              <span class="u-block u-marginTs u-marginBm u-divider"></span>
              <p>
                <span class="u-md-hide"><?php echo e(@trans('woman.youll_have_48')); ?>.</span>
                <span class="u-md-show"><?php echo e(@trans('woman.once_you_approve')); ?></span>
              </p>
            </div>
          </div>
        </li>
        ...
        <li class="Grid-cell timeline-module u-md-size1of2 u-posRelative">
          <div class="u-boxShadow">
            ...
            <div class="timeline-module__content u-textCenter u-paddingAl u-bg-color--white">
              <p class="u-fontWeight--bold"><?php echo e(@trans('woman.try_everything')); ?></p>
              <span class="u-block u-marginTs u-marginBm u-divider"></span>
              <p>
                <span class="u-md-hide"><?php echo e(@trans('woman.take_5_days')); ?></span>
                <span class="u-md-show"><?php echo e(@trans('woman.to_decide')); ?></span>
              </p>
            </div>
          </div>
        </li>
        ...
        <li class="Grid-cell timeline-module u-md-size1of2 u-posRelative">
          <div class="u-boxShadow">
            ...
            <div class="timeline-module__content u-textCenter u-paddingAl u-bg-color--white">
              <p class="u-fontWeight--bold"><?php echo e(@trans('woman.reorder')); ?></p>
              <span class="u-block u-marginTs u-marginBm u-divider"></span>
              <p>
                <span class="u-md-hide"><?php echo e(@trans('woman.our_service')); ?></span>
                <span class="u-md-show"><?php echo e(@trans('woman.works_on_your_terms')); ?>.</span>
              </p>
            </div>
          </div>
        </li>
    ...
    <a href="/checkout/quiz/step/1?gender=woman&cache=flush" class="Button--rounded u-md-hide js-onboarding-cta" data-section="How it works"><?php echo e(@trans('woman.get_started')); ?></a>
  </div>
</section>
...
<section id="pricing" class="u-posRelative" data-behavior="TrunkPricing" style="background-image: url(/assets/kadin6.jpg); background-color:#00273D;">
    ...
    <div class="Grid-cell u-md-size1of2 u-textCenter">
      <h2 class="u-marginBm"><?php echo e(@trans('woman.what_is_cost')); ?></h2>
      ...
      <ul class="pricing-faq u-textLeft">
          ...
          <p class="pricing-faq-question u-fontWeight--bold">
            S. <?php echo e(@trans('woman.q1')); ?>

          </p>
          <div class="pricing-faq-answer u-paddingBs">
            <p><?php echo e(@trans('woman.a1')); ?></p>
          </div>
        </li>
                <li class="pricing-faq-item u-paddingVs u-posRelative">
          <p class="pricing-faq-question u-fontWeight--bold">
            S. <?php echo e(@trans('woman.q2')); ?>

          </p>
          <div class="pricing-faq-answer u-paddingBs">
            <p><?php echo e(@trans('woman.a2')); ?></p>
          </div>
        </li>
                <li class="pricing-faq-item u-paddingVs u-posRelative">
          <p class="pricing-faq-question u-fontWeight--bold">
            S. <?php echo e(@trans('woman.q3')); ?>

          </p>
          <div class="pricing-faq-answer u-paddingBs">
            <p><?php echo e(@trans('woman.a3')); ?></p>
          </div>
        </li>
        
      </ul>
      <a href="/checkout/quiz/step/1?gender=woman&cache=flush" class="Button--rounded u-marginTm js-onboarding-cta" data-section="Pricing"><?php echo e(@trans('woman.get_started')); ?></a>
    </div>
  </div>
</section>
...
<section id="outfits" class="u-posRelative timeline-container u-bg-color--offWhite">
  <div class="u-container u-marginAuto u-textCenter">
    <div class="u-md-size2of3 u-marginAuto">
      <h2 class="u-color--grayDark u-marginBm"><?php echo e(@trans('woman.styles_can_send')); ?></h2>
      <h4 class="u-textSans u-color--grayDark u-marginBm u-marginAuto"><?php echo e(@trans('woman.your_stylist_get')); ?></h4>
    </div>
    ...
    <a href="/checkout/quiz/step/1?gender=woman&cache=flush" class="button--rounded u-marginTxl u-md-hide js-onboarding-cta" data-section="Pricing"><?php echo e(@trans('man.get_started')); ?></a>
  </div>
</section>
...
<section id="trunks" class="u-posRelative" data-behavior="TrunkCheckboxes" style="background-image: url(https://res.cloudinary.com/trunk-club/image/upload/f_auto,q_auto/v1540832135/public_site/2018/holiday/tc-womens-trunks-bg.jpg); background-color:#00273D;">
    <div class="u-container u-marginAuto Grid u-posRelative">
    <div class="Grid-cell u-md-size1of2 u-textCenter">
      <h2 class="u-marginBm"><?php echo e(@trans('woman.what_else')); ?></h2>
      <span class="u-block u-divider u-marginTs u-marginBm"></span>
      <p class="u-marginBl"><?php echo e(@trans('woman.every_trunk')); ?></p>
      ...
      <div class="u-textLeft">
        <div class="line-item u-flex u-flex--alignCenter u-paddingVs">
          <div class="checkbox u-posRelative u-inlineBlock u-marginLs u-marginRm">
            <svg class="checkbox__check u-posAbsolute" width="13px" height="11px" viewBox="0 0 21 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
               <title><?php echo e(@trans('woman.checkmark')); ?></title>
          ...
          <p><?php echo e(@trans('woman.items_per_trunk')); ?></p>
        </div>
        <div class="line-item u-flex u-flex--alignCenter u-paddingVs">
          <div class="checkbox u-posRelative u-inlineBlock u-marginLs u-marginRm">
            <svg class="checkbox__check u-posAbsolute" width="13px" height="11px" viewBox="0 0 21 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <p><?php echo e(@trans('woman.approving_trunks')); ?></p>
        </div>
        <div class="line-item u-flex u-flex--alignCenter u-paddingVs">
          <div class="checkbox u-posRelative u-inlineBlock u-marginLs u-marginRm">
            <svg class="checkbox__check u-posAbsolute" width="13px" height="11px" viewBox="0 0 21 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <p><?php echo e(@trans('woman.free_shipping')); ?></p>
        </div>
        <div class="line-item u-flex u-flex--alignCenter u-paddingVs">
          <div class="checkbox u-posRelative u-inlineBlock u-marginLs u-marginRm">
            <svg class="checkbox__check u-posAbsolute" width="13px" height="11px" viewBox="0 0 21 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <p><?php echo e(@trans('woman.options_to_schedule')); ?>s</p>
        </div>
        <div class="line-item u-flex u-flex--alignCenter u-paddingVs">
          <div class="checkbox u-posRelative u-inlineBlock u-marginLs u-marginRm">
            <svg class="checkbox__check u-posAbsolute" width="13px" height="11px" viewBox="0 0 21 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <p><?php echo e(@trans('woman.alterations_for_trunk')); ?></p>
        </div>
        <div class="line-item u-flex u-flex--alignCenter u-paddingVs js-viewTag">
          ...
          <p><?php echo e(@trans('woman.continued_styling')); ?></p>
        </div>
      </div>

      <a href="/checkout/quiz/step/1?gender=woman&cache=flush" class="Button--rounded u-marginTm js-onboarding-cta" data-section="Pricing"><?php echo e(@trans('man.get_started')); ?></a>
    </div>
  </div>
</section>
