									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="athletic" class="form-element radio" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['vucut']) && session('exist_quiz')['vucut'] == 'cilek'): ?> checked <?php endif; ?> name="quiz[vucut]" type="radio" value="cilek" />
