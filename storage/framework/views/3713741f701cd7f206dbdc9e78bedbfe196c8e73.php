											...
											<div class="row">
												<div class="column width-3">
													<div class="hide-check">
														<input id="expressingStyle-casual" class="form-element check" name="quiz[stil][]" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['stil']) &&  in_array('casual', session('quiz_3')['stil'])): ?> checked <?php endif; ?>  value="casual" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="expressingStyle-smart-casual" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['stil']) &&  in_array('smart_casual', session('quiz_3')['stil'])): ?> checked <?php endif; ?>  name="quiz[stil][]" value="smart_casual" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="expressingStyle-classic" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['stil']) &&  in_array('classic', session('quiz_3')['stil'])): ?> checked <?php endif; ?>  name="quiz[stil][]" value="classic" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="expressingStyle-fashion-forward" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['stil']) &&  in_array('fashion', session('quiz_3')['stil'])): ?> checked <?php endif; ?>  class="form-element check" name="quiz[stil][]" value="fashion" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-3">
													<div class="hide-check">
														<input id="preferStyle-toWork-casual" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['bussiness_stil']) &&  in_array('casual_1', session('quiz_3')['bussiness_stil'])): ?> checked <?php endif; ?>  name="quiz[bussiness_stil][]" value="casual_1" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="preferStyle-toWork-business" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['bussiness_stil']) &&  in_array('bussiness', session('quiz_3')['bussiness_stil'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[bussiness_stil][]" value="bussiness" type="checkbox" />
										...
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-2">
													<div class="hide-check">
														<input id="expressingTshirt-basic" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['tshirt']) &&  in_array('basic', session('quiz_3')['tshirt'])): ?> checked <?php endif; ?> name="quiz[tshirt][]" value="basic" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="expressingTshirt-pattern" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['tshirt']) &&  in_array('pattern', session('quiz_3')['tshirt'])): ?> checked <?php endif; ?> name="quiz[tshirt][]" value="pattern" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="expressingTshirt-hoodies" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['tshirt']) &&  in_array('hoodies', session('quiz_3')['tshirt'])): ?> checked <?php endif; ?> name="quiz[tshirt][]" value="hoodies" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="expressingTshirt-polo" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['tshirt']) &&  in_array('polo', session('quiz_3')['tshirt'])): ?> checked <?php endif; ?> name="quiz[tshirt][]" value="polo" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="expressingTshirt-printed" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['tshirt']) &&  in_array('printed', session('quiz_3')['tshirt'])): ?> checked <?php endif; ?> name="quiz[tshirt][]" value="printed" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="expressingTshirt-oversize" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['tshirt']) &&  in_array('oversize', session('quiz_3')['tshirt'])): ?> checked <?php endif; ?> name="quiz[tshirt][]" value="oversize" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-shirt-regular" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['gomlek']) &&  in_array('regular', session('quiz_3')['gomlek'])): ?> checked <?php endif; ?> name="quiz[gomlek][]" value="regular" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-shirt-fit" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['gomlek']) &&  in_array('fit', session('quiz_3')['gomlek'])): ?> checked <?php endif; ?> name="quiz[gomlek][]" value="fit" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-shirt-slim-fit" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['gomlek']) &&  in_array('slim', session('quiz_3')['gomlek'])): ?> checked <?php endif; ?> name="quiz[gomlek][]" value="slim" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-sweater-bogazli" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['kazak']) &&  in_array('ebogazli', session('quiz_3')['kazak'])): ?> checked <?php endif; ?> name="quiz[kazak][]" value="ebogazli" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-sweater-sifir-yaka" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['kazak']) &&  in_array('esifir', session('quiz_3')['kazak'])): ?> checked <?php endif; ?> name="quiz[kazak][]" value="esifir" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-sweater-v-yaka" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['kazak']) &&  in_array('evyaka', session('quiz_3')['kazak'])): ?> checked <?php endif; ?> name="quiz[kazak][]" value="evyaka" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-pants-regular" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['pantolon']) &&  in_array('regular', session('quiz_3')['pantolon'])): ?> checked <?php endif; ?> name="quiz[pantolon][]" value="regular" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-pants-strech" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['pantolon']) &&  in_array('strech', session('quiz_3')['pantolon'])): ?> checked <?php endif; ?> name="quiz[pantolon][]" value="strech" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-pants-straight" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['pantolon']) &&  in_array('straight', session('quiz_3')['pantolon'])): ?> checked <?php endif; ?> name="quiz[pantolon][]" value="straight" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-pants-slim" class="form-element check" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['pantolon']) &&  in_array('slim', session('quiz_3')['pantolon'])): ?> checked <?php endif; ?> name="quiz[pantolon][]" value="slim" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-lacoste" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['brand']) && in_array('lacoste', session('quiz_3')['brand'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[brand][]" value="lacoste" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-fredperry" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['brand']) && in_array('fredperry', session('quiz_3')['brand'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[brand][]" value="fredperry" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-nike" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['brand']) && in_array('nike', session('quiz_3')['brand'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[brand][]" value="ozel" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-wepublic" <?php if(session()->has('quiz_3') && isset(session('quiz_3')['brand']) && in_array('wepublic', session('quiz_3')['brand'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[brand][]" value="wepublic" type="checkbox" />
