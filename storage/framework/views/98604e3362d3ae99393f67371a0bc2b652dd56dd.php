  ...
  <div class="content clearfix">
  				...
  				<div class="section-block pt-30">
  					<div class="row">
                          ...
                          <?php else: ?>
    												<button class="button bkg-white all-caps" <?php if($gender == ''): ?> onclick="javascript:window.location.href='/start_quiz?cache=flush'; return false;" <?php else: ?> onclick="javascript:window.location.href='/checkout/quiz/step/1?gender=<?php echo e($gender); ?>&cache=flush'; return false;"<?php endif; ?> ><strong>STİL FORMUNA GİT</strong></button>
                          <?php endif; ?>
...
<?php if(request()->segment(2) == 'kadin'): ?>
.column.width-3.man {
  display: none;
}
<?php endif; ?>

<?php if(request()->segment(2) == 'erkek'): ?>
