...
<?php $__env->startSection('content'); ?>
	...
	<?php if(session('gender') == 'man'): ?>
		<?php if($step == 1): ?>
			<?php echo $__env->make('frontend.quizzes.quiz_m_1', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php elseif($step == 2): ?>
			<?php echo $__env->make('frontend.quizzes.quiz_m_2', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php elseif($step == 3): ?>
			<?php echo $__env->make('frontend.quizzes.quiz_m_3', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php elseif($step == 4): ?>
			<?php echo $__env->make('frontend.quizzes.quiz_m_4', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php endif; ?>
	<?php elseif(session('gender') == 'woman'): ?>
		<?php if($step == 1): ?>
			<?php echo $__env->make('frontend.quizzes.quiz_w_1', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php elseif($step == 2): ?>
			<?php echo $__env->make('frontend.quizzes.quiz_w_2', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php elseif($step == 3): ?>
			<?php echo $__env->make('frontend.quizzes.quiz_w_3', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php else: ?>
			<?php echo $__env->make('frontend.quizzes.quiz_w_4', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php endif; ?>
	<?php endif; ?>
<style type="text/css">
	em.error {
