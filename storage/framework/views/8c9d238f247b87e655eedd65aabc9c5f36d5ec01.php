                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo e(trans('Gallery')); ?></th>
                      <th></th>
                    </tr>
                  </thead>
                   <tbody>
                   <?php if(count($results['products'])>0): ?>
                    <?php $__currentLoopData = $results['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    	<tr>
                           ...
                           <td><a class="btn btn-xs btn-primary" role="menuitem" tabindex="-1" href="addProductImages/<?php echo e($product->products_id); ?>"><?php echo e(trans('labels.ProductImages')); ?></a></td>
                            <td>
