            ...
            <div class="rows">
              <div class="field-wrapper">
                <div class="hide-check">
                  <input id="xsmall" class="form-element radio"  name="quiz[üst_beden]" <?php if(session()->has('quiz_2') && session('quiz_2')['üst_beden'] == 'XSMALL'): ?> checked <?php endif; ?> name="quiz[goz_rengi]" type="radio" value="XSMALL" />
                  <label for="xsmall" class="radio-label">XSMALL</label>
                </div>
                <div class="hide-check">
                  <input id="small" class="form-element radio" name="quiz[üst_beden]"  <?php if(session()->has('quiz_2') && session('quiz_2')['üst_beden'] == 'SMALL'): ?> checked <?php endif; ?> type="radio" value="SMALL" />
                  <label for="small" class="radio-label">SMALL</label>
                </div>
                <div class="hide-check">
                  <input id="medium" class="form-element radio" name="quiz[üst_beden]" <?php if(session()->has('quiz_2') && session('quiz_2')['üst_beden'] == 'MEDIUM'): ?> checked <?php endif; ?> type="radio" value="MEDIUM" />
                  <label for="medium" class="radio-label">MEDIUM</label>
                </div>
                <div class="hide-check">
                  <input id="large" class="form-element radio" <?php if(session()->has('quiz_2') && session('quiz_2')['üst_beden'] == 'LARGE'): ?> checked <?php endif; ?> name="quiz[üst_beden]" type="radio" value="LARGE" />
                  <label for="large" class="radio-label">LARGE</label>
                </div>
                <div class="hide-check">
                  <input id="x-large" class="form-element radio" <?php if(session()->has('quiz_2') && session('quiz_2')['üst_beden'] == 'X-LARGE'): ?> checked <?php endif; ?>  name="quiz[üst_beden]" type="radio" value="X-LARGE" />
          ...
          <div class="boxes mb-20">
            ...
            <div class="rows">
              <div class="field-wrapper">
                ...
                <div class="hide-check">
                  <input id="pantolon-<?php echo e($number); ?>" <?php if(session()->has('quiz_2') && isset(session('quiz_2')['pantolon_beden']) && session('quiz_2')['pantolon_beden'] == $number): ?> checked <?php endif; ?> class="form-element radio" name="quiz[pantolon_beden]" type="radio" value="<?php echo e($number); ?>" />
          ...
          <div class="boxes mb-20">
            ...
            <div class="rows">
              <div class="field-wrapper">
                ...
                <?php $__currentLoopData = $numbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="hide-check">
                  <input id="lower-body-<?php echo e($number); ?>" <?php if(session()->has('quiz_2') && session('quiz_2')['alt_beden'] == $number): ?> checked <?php endif; ?> class="form-element radio" name="quiz[alt_beden]" type="radio" value="<?php echo e($number); ?>" />
          ...
          <div class="boxes mb-20">
            ...
            <div class="rows">
              <div class="field-wrapper">
                ...
                <?php $__currentLoopData = $numbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="hide-check">
                  <input id="shoe-size-<?php echo e($number); ?>" <?php if(session()->has('quiz_2') && session('quiz_2')['ayakkabi_no'] == $number): ?> checked <?php endif; ?> class="form-element radio" name="quiz[ayakkabi_no]" type="radio" value="<?php echo e($number); ?>" />
          ...
          <div class="boxes mb-20">
            ...
            <div class="rows">
              <div class="field-wrapper">
                ...
                <?php $__currentLoopData = $numbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="hide-check">
                  <input id="takim-<?php echo e($number); ?>" <?php if(session()->has('quiz_2') && isset(session('quiz_2')['takim_elbise_bedeni']) && session('quiz_2')['takim_elbise_bedeni'] == $number): ?> checked <?php endif; ?> class="form-element radio" name="quiz[takim_elbise_bedeni]" type="radio" value="<?php echo e($number); ?>" />
