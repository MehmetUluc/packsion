      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?php echo e(Request::is('admin/listingPages') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/addPage') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/editPage/*') ? 'active' : ''); ?>">
          <a href="<?php echo e(URL::to('admin/listingPages')); ?>">
            <i class="fa fa-file-text" aria-hidden="true"></i> <span><?php echo e(trans('Sayfalar')); ?></span>
          </a>
        </li>

        <li class="treeview <?php echo e(Request::is('admin/listingFaq') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/addFaq') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/editFaq/*') ? 'active' : ''); ?>">
          <a href="<?php echo e(URL::to('admin/listingFaq')); ?>">
            <i class="fa fa-file-text" aria-hidden="true"></i> <span><?php echo e(trans('Sık Sorulan Sorular')); ?></span>
          </a>
        </li>
        ...
        <li class="treeview <?php echo e(Request::is('admin/slideshows') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/slideshows') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/slideshows/*') ? 'active' : ''); ?>">
          <a href="<?php echo e(URL::to('admin/slideshows')); ?>" ><i class="fa fa-list-ul" aria-hidden="true"></i> <span> Slideshows</span>
          </a>
        </li>
...
<span><?php echo e(trans('labels.link_categories')); ?> </span> <i class="fa fa-angle-left pull-right"></i>
        ...
        <?php endif; ?>
         <li class="treeview <?php echo e(Request::is('admin/editors') ? 'active' : ''); ?>">
          <a href="<?php echo e(URL::to('admin/editors')); ?>">
            <i class="fa fa-dashboard"></i> <span>Editörler</span>
          </a>
        </li>
        <li class="treeview <?php echo e(Request::is('admin/listingProducts') ? 'active' : ''); ?> <?php echo e(Request::is('admin/addProduct') ? 'active' : ''); ?> <?php echo e(Request::is('admin/editAttributes/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/listingAttributes') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/addAttributes') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/editAttributes/*') ? 'active' : ''); ?>">
          ...
          <ul class="treeview-menu">
             <?php if(Auth::user()->type != 'editor'): ?>
            <li class="<?php echo e(Request::is('admin/influencers') ? 'active' : ''); ?> <?php echo e(Request::is('admin/influencers/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/influencers/*') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/influencers')); ?>"><i class="fa fa-circle-o"></i> Influencers</a></li>
            <?php endif; ?>
...
<span><?php echo e(trans('labels.link_notifications')); ?></span> <i class="fa fa-angle-left pull-right"></i>
        ...
        <li class="treeview <?php echo e(Request::is('admin/listingShipments') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/addOrders') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/viewShipment/*') ? 'active' : ''); ?>">
          <a href="<?php echo e(URL::to('admin/listingShipments')); ?>" ><i class="fa fa-list-ul" aria-hidden="true"></i> <span> Shipments</span>
          </a>
        </li>
...
<span> <?php echo e(trans('labels.link_site_settings')); ?></span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php echo e(Request::is('admin/invoice') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/invoice')); ?>"><i class="fa fa-circle-o"></i> <?php echo e(trans('labels.invoice_link')); ?></a></li>
          </ul>
        </li>
