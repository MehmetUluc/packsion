...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> <?php echo e(trans('Sık Sorulan Soru')); ?> <small><?php echo e(trans('Sık Sorulan Soru Düzenle')); ?>...</small> </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('Soru Düzenle')); ?> </h3>
          </div>
            ...
            <div class="row">
              <div class="col-xs-12">
                  <div class="box box-info">
                        ...
                        <!-- form start -->
                         <div class="box-body">
                          ...
                          <?php endif; ?>
                            ...
                            <?php echo Form::open(array('url' =>'admin/updateFaq', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>


                            <?php echo Form::hidden('id',  $result['editPage']->id, array('class'=>'form-control', 'id'=>'id')); ?>
                    ...
                    <input type="text" name="title" class="form-control field-validate" value="<?php echo e($result['editPage']->title); ?>">
                    ...
                    <span class="help-block hidden"><?php echo e(trans('labels.textRequiredFieldMessage')); ?></span>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                    <input type="text" name="position" class="form-control field-validate" value="<?php echo e($result['editPage']->position); ?>">
                    ...
                    <span class="help-block hidden"><?php echo e(trans('labels.textRequiredFieldMessage')); ?></span>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-8">
                                        <textarea id="editor<?=$languages->languages_id?>" name="body" class="form-control" rows="10" cols="80"><?php echo e($result['editPage']->body); ?>
              ...
              <div class="box-footer text-center">
                <button type="submit" class="btn btn-primary"><?php echo e(trans('Gönder')); ?></button>
