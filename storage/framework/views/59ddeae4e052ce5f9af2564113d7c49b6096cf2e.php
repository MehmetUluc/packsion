<div class="content clearfix">
				...
				<div class="section-block min-height-half">
					<div class="row">
					    ...
					    <div class="column width-9">
							...
							<div class="form-group-container">
											...
											<div class="row">
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingStyle-casual" class="form-element check"  <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['stil']) &&  in_array('casual', session('exist_quiz')['stil'])): ?> checked <?php endif; ?>  name="quiz[stil][]" value="casual" type="checkbox" />
                              ...
                              <img src="/assets/images/form/woman/casual.jpg" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingStyle-smart-casual" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['stil']) && in_array('smart_casual', session('exist_quiz')['stil'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[stil][]" value="smart_casual" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingStyle-classic" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['stil']) && in_array('classic', session('exist_quiz')['stil'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[stil][]" value="classic" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingStyle-freppy" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['stil']) && in_array('freppy', session('exist_quiz')['stil'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[stil][]" value="fashion_forward" type="checkbox" />
                        ...
                        <div class="column width-4">
													<div class="hide-check">
														<input id="expressingStyle-fashion-forward" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['stil']) && in_array('fashion', session('exist_quiz')['stil'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[stil][]" value="street_style" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-4">
													<div class="hide-check">
														<input id="preferStyle-toWork-casual" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['bussiness_stil']) && in_array('casual_1', session('exist_quiz')['bussiness_stil'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[bussiness_stil][]" value="casual_1" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="preferStyle-toWork-business" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['bussiness_stil']) &&  in_array('classic', session('exist_quiz')['bussiness_stil'])): ?> checked <?php endif; ?>  class="form-element check" name="quiz[bussiness_stil][]" value="classic_1" type="checkbox" />
                ...
                <div class="boxes mb-20">
										...
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-3">
													<div class="hide-check">
														<input id="preferStyle-group_1"  <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['renk_group1']) && in_array('renk_group1', session('exist_quiz')['renk_group'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[renk_group][]" value="renk_group1" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="preferStyle-group_2" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['renk_group1']) && in_array('renk_group2', session('exist_quiz')['renk_group'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[renk_group][]" value="renk_group2" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="preferStyle-group_3" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['renk_group1']) && in_array('renk_group3', session('exist_quiz')['renk_group'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[renk_group][]" value="renk_group3" type="checkbox" />
                        ...
                        <div class="column width-3">
													<div class="hide-check">
														<input id="preferStyle-group_4"  <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['renk_group1']) && in_array('renk_group4', session('exist_quiz')['renk_group'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[renk_group][]" value="renk_group4" type="checkbox" />
                ...
                <div class="boxes mb-20">
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="notprefer-pattern-7" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['desen']) && in_array('desen7', session('exist_quiz')['desen'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[desen][]" type="checkbox" value="desen7"/>
                        ...
                        <div class="column width-2">
													<div class="hide-check">
														<input id="notprefer-pattern-9" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['desen']) && in_array('desen9', session('exist_quiz')['desen'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[desen][]" type="checkbox" value="desen9"/>
                        ...
                        <div class="column width-2">
													<div class="hide-check">
														<input id="notprefer-pattern-10" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['desen']) && in_array('desen10', session('exist_quiz')['desen'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[desen][]" type="checkbox" value="desen10"/>
                        ...
                        <div class="column width-2">
													<div class="hide-check">
														<input id="notprefer-pattern-12" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['desen']) && in_array('desen12', session('exist_quiz')['desen'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[desen][]" type="checkbox" value="desen12"/>
                        ...
                        <div class="column width-2">
													<div class="hide-check">
														<input id="notprefer-pattern-13" class="form-element check" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['desen']) && in_array('desen13', session('exist_quiz')['desen'])): ?> checked <?php endif; ?> name="quiz[desen][]" type="checkbox" value="desen13"/>
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingTshirt-basic" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['tshirt']) && in_array('croptop', session('exist_quiz')['tshirt'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[tshirt][]" value="croptop" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingTshirt-pattern" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['tshirt']) && in_array('oversize', session('exist_quiz')['tshirt'])): ?> checked <?php endif; ?>  class="form-element check" name="quiz[tshirt][]" value="oversize" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingTshirt-hoodies" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['tshirt']) && in_array('straight', session('exist_quiz')['tshirt'])): ?> checked <?php endif; ?>  class="form-element check" name="quiz[tshirt][]" value="straight" type="checkbox" />
                  ...
                  <div class="rows">
                    <div class="field-wrapper body-type">
                      <div class="row">
                        <div class="column width-4">
                          <div class="hide-check">
                            <input id="prefer-pants-regular" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['pantolon']) && in_array('clutte', session('exist_quiz')['pantolon'])): ?> checked <?php endif; ?>  class="form-element check" name="quiz[pantolon][]" value="clutte" type="checkbox" />
                        ...
                        <div class="column width-4">
                          <div class="hide-check">
                            <input id="prefer-pants-strech" <?php if(session()->has('exist_quiz')  && isset(session('exist_quiz')['pantolon']) && in_array('wideleg', session('exist_quiz')['pantolon'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[pantolon][]" value="wideleg" type="checkbox" />
                        ...
                        <div class="column width-4">
                          <div class="hide-check">
                            <input id="prefer-pants-straight" <?php if(session()->has('exist_quiz')  && isset(session('exist_quiz')['pantolon']) && in_array('carrotleg', session('exist_quiz')['pantolon'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[pantolon][]" value="carrotleg" type="checkbox" />
                        ...
                        <div class="column width-4">
                          <div class="hide-check">
                            <input id="prefer-pants-slim"  <?php if(session()->has('exist_quiz')  && isset(session('exist_quiz')['pantolon']) && in_array('straight', session('exist_quiz')['pantolon'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[pantolon][]" value="straight" type="checkbox" />
                        ...
                        <div class="column width-4">
                          <div class="hide-check">
                            <input id="prefer-pants-skinny" <?php if(session()->has('exist_quiz')  && isset(session('exist_quiz')['pantolon']) && in_array('skinny', session('exist_quiz')['pantolon'])): ?> checked <?php endif; ?>  class="form-element check" name="quiz[pantolon][]" value="skinny" type="checkbox" />
                        ...
                        <div class="column width-4">
                          <div class="hide-check">
                            <input id="prefer-pants-tayt" <?php if(session()->has('exist_quiz')  && isset(session('exist_quiz')['pantolon']) && in_array('tayt', session('exist_quiz')['pantolon'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[pantolon][]" value="tayt" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-skirt-1" class="form-element check" <?php if(session()->has('exist_quiz')  && isset(session('exist_quiz')['etek']) && in_array('mini', session('exist_quiz')['etek'])): ?> checked <?php endif; ?> name="quiz[etek][]" value="mini" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-skirt-2" class="form-element check" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['etek']) && in_array('midi', session('exist_quiz')['etek'])): ?> checked <?php endif; ?> name="quiz[etek][]" value="midi" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-skirt-3" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['etek']) && in_array('flared', session('exist_quiz')['etek'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[etek][]" value="flared" type="checkbox" />
                        ...
                        <div class="column width-4">
													<div class="hide-check">
														<input id="prefer-skirt-4" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['etek']) && in_array('pencil', session('exist_quiz')['etek'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[etek][]" value="pencil" type="checkbox" />
                        ...
                        <div class="column width-4">
													<div class="hide-check">
														<input id="prefer-skirt-5" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['etek']) && in_array('maxi', session('exist_quiz')['etek'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[etek][]" value="maxi" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-sweater-bogazli" class="form-element check" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['kazak']) && in_array('balikci_yaka', session('exist_quiz')['kazak'])): ?> checked <?php endif; ?> name="quiz[kazak][]" value="balikci_yaka" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-sweater-sifir-yaka" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['kazak']) && in_array('oversized', session('exist_quiz')['kazak'])): ?> checked <?php endif; ?>  class="form-element check" name="quiz[kazak][]" value="oversized" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-sweater-v-yaka"  <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['kazak']) && in_array('croptop', session('exist_quiz')['kazak'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[kazak][]" value="croptop" type="checkbox" />
                       							 ...
                       							 <div class="column width-4">
													<div class="hide-check">
														<input id="prefer-sweater-y-yaka" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['kazak']) && in_array('hirka', session('exist_quiz')['kazak'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[kazak][]" value="hirka" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-sweater-y-yaka" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['kazak']) && in_array('yuvarlakyaka', session('exist_quiz')['kazak'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[kazak][]" value="yuvarlakyaka" type="checkbox" />
														<label for="prefer-sweater-y-yaka" class="checkbox-label tooltip-image">
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-yargici" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['brand']) && in_array('yargici', session('exist_quiz')['brand'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[brand][]" value="yargici" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-stefanel" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['brand']) && in_array('stefanel', session('exist_quiz')['brand'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[brand][]" value="stefanel" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-nike" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['brand']) && in_array('nike', session('exist_quiz')['brand'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[brand][]" value="nike" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-adl" <?php if(session()->has('exist_quiz') && isset(session('exist_quiz')['brand']) && in_array('adl', session('exist_quiz')['brand'])): ?> checked <?php endif; ?> class="form-element check" name="quiz[brand][]" value="adl" type="checkbox" />
