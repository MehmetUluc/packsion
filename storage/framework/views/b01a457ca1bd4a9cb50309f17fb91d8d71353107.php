<div class="content clearfix">
            ...
            <?php echo $__env->make('frontend.quizzes.right', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <div class="boxes mb-20">
                  ...
                  <div class="rows">
                    <div class="field-wrapper ozel">
                      <?php 
                        $numbers = ['Omuzlar', 'Kollar', 'Sırt', 'Göğüs', 'Karın', 'Bacaklar', 'Basen', 'Hepsi']
                       ?>
                      ...
                      <div class="hide-check" style="margin-right:1rem !important;">
			...
			<style type="text/css">
				@media  only screen and (max-width: 600px) {
					.wizard .field-wrapper.ozel .hide-check {
    width: calc(41% - 1rem);
    margin-right: 0;
    float: left;
}
