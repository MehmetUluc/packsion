      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <form>
              <div class="col-md-3">
                <input type="text" class="form-control" placeholder="Ad Soyad" name="name" value="<?php echo e(request('name')); ?>">
              </div>
              <div class="col-md-2">
            ...
            <div class="box-tools pull-right">
              <ul style="list-style: none;">
               <li> <a href="addCustomers" type="button" class="btn btn-block btn-primary"><?php echo e(trans('labels.AddNewCustomers')); ?></a></li>
                 <li><a href="toexcel" type="button" class="btn btn-block btn-success"><?php echo e(trans('Excele Dök')); ?></a></li>
              </ul>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo e(trans('labels.Quizzes')); ?></th>
                      <th><?php echo e(trans('labels.RegisterDate')); ?></th>
                      <th><?php echo e(trans('labels.FirstPurchase')); ?></th>
                      <th><?php echo e(trans('Durum')); ?></th>
                   ...
                   <?php if(count($customers['result']) > 0): ?>
						<?php $__currentLoopData = $customers['result']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$listingCustomers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
                                ...
                                <td>
                                      <?php if(count($listingCustomers->quizzes)>0): ?>
                                        <?php $__currentLoopData = $listingCustomers->quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                          <a class="badge bg-red" target="_blank" href="/admin/pdf1/<?php echo e($quiz->id); ?>"><?php echo e($quiz->title); ?></a>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      <?php endif; ?>
                                    ...
                                    <td><?php echo e(date('d/m/Y', strtotime($listingCustomers->created_at))); ?></td>
                                    <td>
                                    <?php if(isset($listingCustomers->orders)): ?>
                                      <?php echo e(date('d/m/Y', strtotime($listingCustomers->orders->date_purchased))); ?>
                                    ...
                                    <td><?php 
                                      ...
                                      <?php if($shipment): ?>
                                        <?php if($shipment->status == 'completed' || $shipment->status == 'shipped'): ?>
                                          <label class="label label-primary">Üyelik Tamamlandıi</label>
                                        <?php elseif($shipment->status == 'pending' || $shipment->status == 'paid'): ?>
                                          <label class="label label-success">Aktif Müşteri</label>

                                        <?php elseif($shipment->status == 'cancel'): ?>

                                          <label class="label label-warning">İptal Edilmiş</label>
                                        <?php elseif($shipment->status == 'freeze'): ?>
