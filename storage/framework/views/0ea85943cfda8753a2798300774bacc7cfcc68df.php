...
<div class="content clearfix">
                            ...
                            <div class="title-container">
                                <div class="title-container-inner">
                                    <ul class="nav nav-steps">
                                        <?php if(session()->has('without_quiz')): ?>
                        ...
                        <div class="column width-9">
                            ...
                            <div class="form-group-container">
                                                ...
                                                <div class="column width-6">
                                                    <div class="form-select form-element large">
                                                        <select name="address" tabindex="1" class="form-aux" data-label="Adres seç" required>
                                                            ...
                                                            <option <?php if(session('address_id') == $address->address_book_id): ?> selected <?php endif; ?> value="<?php echo e($address->address_book_id); ?>"><?php echo e($address->entry_name); ?></option>
                                ...
                                <div class="boxes mb-20">
                                    ...
                                    <div class="row">
                                        <div class="column width-6">
                                            <input id="promotion" type="text" name="promotion" class="form-promotion-code form-element large" value="<?php echo e(session('coupon')); ?>" placeholder="Promosyon kodu" tabindex="2" />
                                        </div>
                                        <div class="column width-6">
                ...
                <div id="agreement-modal" class="section-block pt-50 pb-20 background-none hide">
                    <div class="row">
                        <div class="column width-12">
                            <p class="fw-300">
                                <?php echo $__env->make('mesafeli', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div id="agreement-modal-2" class="section-block pt-50 pb-20 background-none hide">
                    <div class="row">
                        <div class="column width-12">
                            <p class="fw-300">
                                <?php echo $__env->make('satis', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </p>
                        </div>
                    </div>
                </div>
