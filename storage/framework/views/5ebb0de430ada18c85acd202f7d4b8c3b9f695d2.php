				...
				<div class="section-block intro-title-2 xsmall bkg-charcoal-transition no-height">
					<div class="row">
						<div class="column width-12">
                            ...
                            <?php  $video = explode('v=', 'https://www.youtube.com/watch?v=UhMwi_8E4Ow');  ?>
														<a href="https://www.youtube.com/embed/<?php echo e(end($video)); ?>?autoplay=1&amp;showinfo=0&amp;loop=1" data-caption="Packsion" class="lightbox-link icon-play bkg-hover-theme color-white color-hover-white xxxlarge"></a>
													</div>
												</div>
											</div>
										</div>
