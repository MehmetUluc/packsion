...
<div class="middle">
                <h2>Merhaba <?php echo e($customer->customers_firstname . ' ' . $customer->customers_lastname); ?>,</h2>
                <p>Siparişiniz başarıyla oluşturuldu!</p>
                <h5>Siparişinize ait detaylar aşağıdadır</h5>
                ...
                <table>
                    ...
                    <tr>
                        <th>Sipariş Kodu</th>
                        <td><?php echo e($order->orders_id); ?></td>
                    </tr>
                    <tr>
                        <th>Ürün Adı:</th>
                    ...
                    <tr>
                        ...
                        <td><?php echo e(date('d.m.Y', strtotime($last_ship->ship_at))); ?></td>
                    </tr>
                </table>
