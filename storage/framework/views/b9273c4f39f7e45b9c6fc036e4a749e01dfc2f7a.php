                         ...
                         <div class="box-body">
                          ...
                          <?php endif; ?>
                            ...
                            <?php echo Form::open(array('url' =>'admin/updateProduct', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                ...
                                <div class="form-group">
                                  <label for="influencer_id" class="col-sm-2 col-md-3 control-label"><?php echo e('Influencer'); ?></label>
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control" id="influencer_id" name="influencer_id">
                                         <option value=""><?php echo e('Seçiniz'); ?></option>
                                        <?php $__currentLoopData = $result['influencers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                           <option <?php if($result['product'][0]->influencer == $categories->id): ?> selected <?php endif; ?> value="<?php echo e($categories->id); ?>"><?php echo e($categories->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  <label for="gender" class="col-sm-2 col-md-3 control-label"><?php echo e('Cinsiyet'); ?></label>
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control" id="gender" name="gender">
                                         <option value=""><?php echo e('Seçiniz'); ?></option>
                                        
                                           <option <?php if($result['product'][0]->gender == 'Erkek'): ?> selected <?php endif; ?> value="Erkek">Erkek</option>
                                           <option <?php if($result['product'][0]->gender == 'Kadın'): ?> selected <?php endif; ?> value="Kadın">Kadın</option>
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('SKU')); ?> </label>
                                    <div class="col-sm-10 col-md-4">
                                        <input type="text" name="sku" class="form-control field-validate" <?php if(!empty($result['product'][$i]->sku)): ?> value="<?php echo e($result['product'][$i]->sku); ?>" <?php endif; ?>>
                                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                              ...
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    ...
                                    <br>
                                    <?php echo Form::hidden('oldImage',  $result['product'][0]->products_image , array('id'=>'oldImage')); ?>
