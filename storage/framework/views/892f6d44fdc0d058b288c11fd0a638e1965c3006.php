...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> <?php echo e(trans('Sık Sorulan Soru')); ?> <small><?php echo e(trans('Kategori Düzenle')); ?>...</small> </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('Kategori Düzenle')); ?> </h3>
          </div>
                        ...
                        <!-- form start -->
                         <div class="box-body">
                          ...
                          <?php endif; ?>
                            ...
                            <?php echo Form::open(array('url' =>'admin/updateFaqCategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
