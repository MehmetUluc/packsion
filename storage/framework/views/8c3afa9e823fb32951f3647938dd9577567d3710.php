          ...
          <div class="boxes mb-20">
            ...
            <div class="rows">
              <div class="field-wrapper">
                ...
                <div class="hide-check">
                  <input id="standart-<?php echo e($number); ?>" <?php if(session()->has('quiz_2') && session('quiz_2')['standart_beden'] == $number): ?> checked <?php endif; ?> class="form-element radio" name="quiz[standart_beden]" type="radio" value="<?php echo e($number); ?>" />
          ...
          <div class="boxes mb-20">
            ...
            <div class="rows">
              <div class="field-wrapper">
                ...
                <?php $__currentLoopData = $numbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="hide-check">
                  <input id="pantolon-<?php echo e($number); ?>" <?php if(session()->has('quiz_2') && isset(session('quiz_2')['kot_beden']) && session('quiz_2')['kot_beden'] == $number): ?> checked <?php endif; ?> class="form-element radio" name="quiz[kot_beden]" type="radio" value="<?php echo e($number); ?>" />
