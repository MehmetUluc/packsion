...
$(document).ready(function(){
	...
	function strIntrvl(){
		intrvl = setInterval(function(){
			if(nextSlideCount + 1 > totalItem){
				nextSlideCount = 0;
			}
			var elm = ".slider-pagination .button[data-order='" + (nextSlideCount + 1) + "']";
			$(elm).click();
		}, 6000);
	}
});