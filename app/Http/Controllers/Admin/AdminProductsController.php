...
class AdminProductsController extends Controller
{
	...
	public function getApiProduct(Request $request)
	{
		...
		$products = DB::table('products')->join('products_to_categories', 'products_to_categories.products_id', 'products.products_id')
					->join('products_description', 'products_description.products_id', 'products.products_id')
					->where('products_to_categories.categories_id', 31)->where('products_description.products_name', 'LIKE', '%' . $term . '%')->get();
	...
	public function addProduct(Request $request){
		...
		$latest_id = DB::table('products')->orderBy('products_id', 'DESC')->first();

		$result['influencers'] = App\Influencer::all();

		//print_r($latest_id); exit;

		$result['latest'] = $latest_id->products_id + 1;
	...
	public function editProduct(Request $request){
		...
		$result['influencers'] = App\Influencer::all();
		//$result['influencer'] = $product->influencer;
