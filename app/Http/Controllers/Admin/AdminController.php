...
class AdminController extends Controller
{
	public function dashboard(Request $request){
		if(Auth::user()->type == 'editor'){
			return redirect('/admin/listingShipments');
		}
...
//		}
	...
	public function signup(){
		$title 			  = 	array('pageTitle' => Lang::get("Editör Ekleme"));
		return view('admin.user.new_user', $title);
	}
	...
	public function createEditor(Request $request)
	{
		...
		$user->image = 'resources/views/admin/images/admin_profile/1505132393.1486628854.fast.jpg';
	...
	{	$title 			  = 	array('pageTitle' => Lang::get("Editörler"));
		$editors  = Administrator::where('type', 'editor')->paginate(50);

		return view('admin.user.editors', $title)->with('editors', $editors);
	}
	...
	public function passreset(Request $request){
		...
		$orders_status = DB::table('administrators')->where('myid','=', 1)->update([
				'password'		=>	Hash::make('Ferh4n1982')
				]);
