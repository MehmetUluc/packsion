							...
							<div class="title-container">
								<div class="title-container-inner">
									<ul class="nav nav-steps">
										...
										<li class="past"><a href="/account/quiz/{{ request()->segment(3) }}/step/2"><span>2</span> Beden ölçüleri</a></li>
										<li class="past"><a href="/account/quiz/{{ request()->segment(3) }}/step/3"><span>3</span> Stil</a></li>
										<li class="active"><a href="/account/quiz/{{ request()->segment(3) }}/step/4"><span>4</span> Tercihler</a></li>
