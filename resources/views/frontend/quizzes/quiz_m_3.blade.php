											...
											<div class="row">
												<div class="column width-3">
													<div class="hide-check">
														<input id="expressingStyle-casual" class="form-element check" name="quiz[stil][]" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['stil']) &&  in_array('casual', session('exist_quiz')['stil'])) checked @endif  value="casual" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="expressingStyle-smart-casual" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['stil']) &&  in_array('smart_casual', session('exist_quiz')['stil'])) checked @endif  name="quiz[stil][]" value="smart_casual" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="expressingStyle-classic" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['stil']) &&  in_array('classic', session('exist_quiz')['stil'])) checked @endif  name="quiz[stil][]" value="classic" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="expressingStyle-fashion-forward" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['stil']) &&  in_array('fashion', session('exist_quiz')['stil'])) checked @endif  class="form-element check" name="quiz[stil][]" value="fashion" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-3">
													<div class="hide-check">
														<input id="preferStyle-toWork-casual" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['bussiness_stil']) &&  in_array('casual_1', session('exist_quiz')['bussiness_stil'])) checked @endif  name="quiz[bussiness_stil][]" value="casual_1" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="preferStyle-toWork-business" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['bussiness_stil']) &&  in_array('bussiness', session('exist_quiz')['bussiness_stil'])) checked @endif class="form-element check" name="quiz[bussiness_stil][]" value="bussiness" type="checkbox" />
										...
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-2">
													<div class="hide-check">
														<input id="expressingTshirt-basic" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['tshirt']) &&  in_array('basic', session('exist_quiz')['tshirt'])) checked @endif name="quiz[tshirt][]" value="basic" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="expressingTshirt-pattern" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['tshirt']) &&  in_array('pattern', session('exist_quiz')['tshirt'])) checked @endif name="quiz[tshirt][]" value="pattern" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="expressingTshirt-hoodies" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['tshirt']) &&  in_array('hoodies', session('exist_quiz')['tshirt'])) checked @endif name="quiz[tshirt][]" value="hoodies" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="expressingTshirt-polo" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['tshirt']) &&  in_array('polo', session('exist_quiz')['tshirt'])) checked @endif name="quiz[tshirt][]" value="polo" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="expressingTshirt-printed" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['tshirt']) &&  in_array('printed', session('exist_quiz')['tshirt'])) checked @endif name="quiz[tshirt][]" value="printed" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="expressingTshirt-oversize" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['tshirt']) &&  in_array('oversize', session('exist_quiz')['tshirt'])) checked @endif name="quiz[tshirt][]" value="oversize" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-shirt-regular" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['gomlek']) &&  in_array('regular', session('exist_quiz')['gomlek'])) checked @endif name="quiz[gomlek][]" value="regular" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-shirt-fit" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['gomlek']) &&  in_array('fit', session('exist_quiz')['gomlek'])) checked @endif name="quiz[gomlek][]" value="fit" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-shirt-slim-fit" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['gomlek']) &&  in_array('slim', session('exist_quiz')['gomlek'])) checked @endif name="quiz[gomlek][]" value="slim" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-sweater-bogazli" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['kazak']) &&  in_array('ebogazli', session('exist_quiz')['kazak'])) checked @endif name="quiz[kazak][]" value="ebogazli" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-sweater-sifir-yaka" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['kazak']) &&  in_array('esifir', session('exist_quiz')['kazak'])) checked @endif name="quiz[kazak][]" value="esifir" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-sweater-v-yaka" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['kazak']) &&  in_array('evyaka', session('exist_quiz')['kazak'])) checked @endif name="quiz[kazak][]" value="evyaka" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-pants-regular" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['pantolon']) &&  in_array('regular', session('exist_quiz')['pantolon'])) checked @endif name="quiz[pantolon][]" value="regular" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-pants-strech" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['pantolon']) &&  in_array('strech', session('exist_quiz')['pantolon'])) checked @endif name="quiz[pantolon][]" value="strech" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-pants-straight" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['pantolon']) &&  in_array('straight', session('exist_quiz')['pantolon'])) checked @endif name="quiz[pantolon][]" value="straight" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="prefer-pants-slim" class="form-element check" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['pantolon']) &&  in_array('slim', session('exist_quiz')['pantolon'])) checked @endif name="quiz[pantolon][]" value="slim" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-lacoste" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['brand']) && in_array('lacoste', session('exist_quiz')['brand'])) checked @endif class="form-element check" name="quiz[brand][]" value="lacoste" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-fredperry" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['brand']) && in_array('fredperry', session('exist_quiz')['brand'])) checked @endif class="form-element check" name="quiz[brand][]" value="fredperry" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-nike" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['brand']) && in_array('nike', session('exist_quiz')['brand'])) checked @endif class="form-element check" name="quiz[brand][]" value="ozel" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-wepublic" @if(session()->has('exist_quiz') && isset(session('exist_quiz')['brand']) && in_array('wepublic', session('exist_quiz')['brand'])) checked @endif class="form-element check" name="quiz[brand][]" value="wepublic" type="checkbox" />
