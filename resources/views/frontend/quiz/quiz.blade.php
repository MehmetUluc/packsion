...
@section('content')
	...
	@if(session('gender') == 'man')
		@if($step == 1)
			@include('frontend.quiz.quiz_m_1')
		@elseif($step == 2)
			@include('frontend.quiz.quiz_m_2')
		@elseif($step == 3)
			@include('frontend.quiz.quiz_m_3')
		@elseif($step == 4)
			@include('frontend.quiz.quiz_m_4')
		@endif
	@elseif(session('gender') == 'woman')
		@if($step == 1)
			@include('frontend.quiz.quiz_w_1')
		@elseif($step == 2)
			@include('frontend.quiz.quiz_w_2')
		@elseif($step == 3)
			@include('frontend.quiz.quiz_w_3')
		@else($step == 4)
			@include('frontend.quiz.quiz_w_4')
		@endif
	@endif
<style type="text/css">
	em.error {
