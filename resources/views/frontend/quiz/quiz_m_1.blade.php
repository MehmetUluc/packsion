...
rızam olduğunu kabul ve beyan ederim.</label>
								...
								<div class="boxes mb-30">
									...
									<div class="row">
										<div class="column width-4">
											<input type="text" name="quiz[title]" class="form-name form-element large" placeholder="İsim" tabindex="4"  value="{{ session('quiz_1')['title'] ?? ''  }}" required />
										</div>
										<div class="column width-4">
											<input type="text" name="quiz[dob]" value="{{ session('quiz_1')['dob'] ?? ''  }}" autocomplete="off" class="form-birthday form-element large" placeholder="Doğum Tarihiniz" id="datepicker" required />
										</div>
										<div class="column width-4">
											<input type="text" name="quiz[job]" value="{{ session('quiz_1')['job'] ?? ''  }}" class="form-job form-element large" placeholder="Mesleğiniz" tabindex="6" required />
										</div>
									</div>
								</div>
								<div class="boxes mb-40">
									...
									<div class="rows">
										<div id="your-length" class="slider-box">
											<div class="value-box">
										  		<span class="current-value">{{ session('quiz_1')['boy'] ?? '140'  }}</span>
										  		<span>cm</span>
										  	</div>
										  	<input type="hidden" class="quiz_boy" name="quiz[boy]" value="{{ session('quiz_1')['boy'] ?? '140'  }}" />
										</div>
								...
								<div class="boxes mb-40">
									...
									<div class="rows">
										<div id="your-weight" class="slider-box">
											<div class="value-box">
										  		<span class="current-value">{{ session('quiz_1')['kilo'] ?? '40'  }}</span>
										  		<span>kg</span>
										  	</div>
										  	<input type="hidden" class="quiz_kilo" name="quiz[kilo]" value="{{ session('quiz_1')['kilo'] ?? '40'  }}" />
										</div>
										<div class="bottom-value">
									  		<span>40 kg</span>
									  		<span>150 kg</span>
								...
								<div class="boxes mb-30">
									...
									<div class="row">
										<div class="column width-4">
											<input type="text" name="quiz[sac_rengi]" value="{{ session('quiz_1')['sac_rengi'] ?? ''  }}"  class="form-hair-color form-element large" placeholder="Saç renginiz" tabindex="4" required />
										</div>
									</div>
								</div>
								<div class="boxes mb-30">
									...
									<div class="rows">
										<div class="field-wrapper">
											<div class="hide-check">
												<input id="brown" class="form-element radio" @if(session()->has('quiz_1') && isset(session('quiz_1')['goz_rengi']) && session('quiz_1')['goz_rengi'] == 'Kahverengi') checked @endif name="quiz[goz_rengi]" type="radio" value="Kahverengi" />
												<label for="brown" class="radio-label">Kahverengi</label>
											</div>
											<div class="hide-check">
												<input id="blue" class="form-element radio" @if(session()->has('quiz_1') && isset(session('quiz_1')['goz_rengi']) &&  session('quiz_1')['goz_rengi'] == 'Mavi') checked @endif name="quiz[goz_rengi]" type="radio" value="Mavi" />
												<label for="blue" class="radio-label">Mavi</label>
											</div>
											<div class="hide-check">
												<input id="hazel" class="form-element radio" name="quiz[goz_rengi]" @if(session()->has('quiz_1') && isset(session('quiz_1')['goz_rengi']) &&  session('quiz_1')['goz_rengi'] == 'Ela') checked @endif type="radio" value="Ela" />
												<label for="hazel" class="radio-label">Ela</label>
											</div>
											<div class="hide-check">
												<input id="green" class="form-element radio" @if(session()->has('quiz_1') && isset(session('quiz_1')['goz_rengi']) &&  session('quiz_1')['goz_rengi'] == 'Yeşil') checked @endif name="quiz[goz_rengi]" type="radio" value="Yeşil" />
								...
								<div class="boxes mb-30">
									...
									<div class="rows">
										<div class="field-wrapper">
											<div class="hide-check">
												<input id="white" @if(session()->has('quiz_1') && isset(session('quiz_1')['ten_rengi']) &&  session('quiz_1')['ten_rengi'] == 'Beyaz') checked @endif class="form-element radio" name="quiz[ten_rengi]" type="radio" value="Beyaz" />
												<label for="white" class="radio-label">Beyaz</label>
											</div>
											<div class="hide-check">
												<input id="auburn"  @if(session()->has('quiz_1') && isset(session('quiz_1')['ten_rengi']) && session('quiz_1')['ten_rengi'] == 'Buğday') checked @endif class="form-element radio" name="quiz[ten_rengi]" type="radio" value="Buğday" />
												<label for="auburn" class="radio-label">Buğday</label>
											</div>
											<div class="hide-check">
												<input id="brunette" class="form-element radio" @if(session()->has('quiz_1') && isset(session('quiz_1')['ten_rengi']) && session('quiz_1')['ten_rengi'] == 'Esmer') checked @endif name="quiz[ten_rengi]" type="radio" value="Esmer" />
										...
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-2">
													<div class="hide-check">
														<input id="pear" class="form-element radio" @if(session()->has('quiz_1') && isset(session('quiz_1')['vucut']) && session('quiz_1')['vucut'] == 'armut') checked @endif name="quiz[vucut]" type="radio" value="armut"/>
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="athletic" class="form-element radio" @if(session()->has('quiz_1') && isset(session('quiz_1')['vucut']) && session('quiz_1')['vucut'] == 'atletik') checked @endif name="quiz[vucut]" type="radio" value="atletik" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="apple" class="form-element radio" @if(session()->has('quiz_1') && isset(session('quiz_1')['vucut']) && session('quiz_1')['vucut'] == 'elma') checked @endif name="quiz[vucut]" type="radio" value="elma" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="straight" class="form-element radio" @if(session()->has('quiz_1') && isset(session('quiz_1')['vucut']) && session('quiz_1')['vucut'] == 'duz') checked @endif name="quiz[vucut]" type="radio" value="duz" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="hourglass" class="form-element radio" @if(session()->has('quiz_1') && isset(session('quiz_1')['vucut']) && session('quiz_1')['vucut'] == 'kumsaati') checked @endif name="quiz[vucut]" type="radio" value="kumsaati" />
