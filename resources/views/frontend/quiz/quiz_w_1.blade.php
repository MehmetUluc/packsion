...
rızam olduğunu kabul ve beyan ederim.</label>
								...
								<div class="boxes mb-30">
									...
									<div class="row">
										<div class="column width-4">
											<input type="text" name="quiz[title]" class="form-name form-element large" placeholder="İsim" tabindex="1"  value="{{ session('quiz_1')['title'] ?? ''  }}" required />
										</div>
										<div class="column width-4">
										...
										<div class="column width-4">
											<input type="text" name="quiz[job]" value="{{ session('quiz_1')['job'] ?? ''  }}" class="form-job form-element large" placeholder="Mesleğiniz" tabindex="3" required />
										</div>
									</div>
								</div>
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="athletic" class="form-element radio" @if(session()->has('quiz_1') && isset(session('quiz_1')['vucut']) && session('quiz_1')['vucut'] == 'cilek') checked @endif name="quiz[vucut]" type="radio" value="cilek" />
