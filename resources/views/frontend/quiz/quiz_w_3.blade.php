<div class="content clearfix">
				...
				<div class="section-block min-height-half">
					<div class="row">
					    ...
					    <div class="column width-9">
							...
							<div class="form-group-container">
											...
											<div class="row">
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingStyle-casual" class="form-element check"  @if(session()->has('quiz_3') && isset(session('quiz_3')['stil']) &&  in_array('casual', session('quiz_3')['stil'])) checked @endif  name="quiz[stil][]" value="casual" type="checkbox" />
                              ...
                              <img src="/assets/images/form/woman/casual.jpg" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingStyle-smart-casual" @if(session()->has('quiz_3') && isset(session('quiz_3')['stil']) && in_array('smart_casual', session('quiz_3')['stil'])) checked @endif class="form-element check" name="quiz[stil][]" value="smart_casual" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingStyle-classic" @if(session()->has('quiz_3') && isset(session('quiz_3')['stil']) && in_array('classic', session('quiz_3')['stil'])) checked @endif class="form-element check" name="quiz[stil][]" value="classic" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingStyle-freppy" @if(session()->has('quiz_3') && isset(session('quiz_3')['stil']) && in_array('freppy', session('quiz_3')['stil'])) checked @endif class="form-element check" name="quiz[stil][]" value="fashion_forward" type="checkbox" />
                        ...
                        <div class="column width-4">
													<div class="hide-check">
														<input id="expressingStyle-fashion-forward" @if(session()->has('quiz_3') && isset(session('quiz_3')['stil']) && in_array('fashion', session('quiz_3')['stil'])) checked @endif class="form-element check" name="quiz[stil][]" value="street_style" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-4">
													<div class="hide-check">
														<input id="preferStyle-toWork-casual" @if(session()->has('quiz_3') && isset(session('quiz_3')['bussiness_stil']) && in_array('casual_1', session('quiz_3')['bussiness_stil'])) checked @endif class="form-element check" name="quiz[bussiness_stil][]" value="casual_1" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="preferStyle-toWork-business" @if(session()->has('quiz_3') && isset(session('quiz_3')['bussiness_stil']) &&  in_array('classic', session('quiz_3')['bussiness_stil'])) checked @endif  class="form-element check" name="quiz[bussiness_stil][]" value="classic_1" type="checkbox" />
                ...
                <div class="boxes mb-20">
										...
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-3">
													<div class="hide-check">
														<input id="preferStyle-group_1"  @if(session()->has('quiz_3') && isset(session('quiz_3')['renk_group1']) && in_array('renk_group1', session('quiz_3')['renk_group'])) checked @endif class="form-element check" name="quiz[renk_group][]" value="renk_group1" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="preferStyle-group_2" @if(session()->has('quiz_3') && isset(session('quiz_3')['renk_group1']) && in_array('renk_group2', session('quiz_3')['renk_group'])) checked @endif class="form-element check" name="quiz[renk_group][]" value="renk_group2" type="checkbox" />
												...
												<div class="column width-3">
													<div class="hide-check">
														<input id="preferStyle-group_3" @if(session()->has('quiz_3') && isset(session('quiz_3')['renk_group1']) && in_array('renk_group3', session('quiz_3')['renk_group'])) checked @endif class="form-element check" name="quiz[renk_group][]" value="renk_group3" type="checkbox" />
                        ...
                        <div class="column width-3">
													<div class="hide-check">
														<input id="preferStyle-group_4"  @if(session()->has('quiz_3') && isset(session('quiz_3')['renk_group1']) && in_array('renk_group4', session('quiz_3')['renk_group'])) checked @endif class="form-element check" name="quiz[renk_group][]" value="renk_group4" type="checkbox" />
                ...
                <div class="boxes mb-20">
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="notprefer-pattern-7" @if(session()->has('quiz_3') && isset(session('quiz_3')['desen']) && in_array('desen7', session('quiz_3')['desen'])) checked @endif class="form-element check" name="quiz[desen][]" type="checkbox" value="desen7"/>
                        ...
                        <div class="column width-2">
													<div class="hide-check">
														<input id="notprefer-pattern-9" @if(session()->has('quiz_3') && isset(session('quiz_3')['desen']) && in_array('desen9', session('quiz_3')['desen'])) checked @endif class="form-element check" name="quiz[desen][]" type="checkbox" value="desen9"/>
                        ...
                        <div class="column width-2">
													<div class="hide-check">
														<input id="notprefer-pattern-10" @if(session()->has('quiz_3') && isset(session('quiz_3')['desen']) && in_array('desen10', session('quiz_3')['desen'])) checked @endif class="form-element check" name="quiz[desen][]" type="checkbox" value="desen10"/>
                        ...
                        <div class="column width-2">
													<div class="hide-check">
														<input id="notprefer-pattern-12" @if(session()->has('quiz_3') && isset(session('quiz_3')['desen']) && in_array('desen12', session('quiz_3')['desen'])) checked @endif class="form-element check" name="quiz[desen][]" type="checkbox" value="desen12"/>
                        ...
                        <div class="column width-2">
													<div class="hide-check">
														<input id="notprefer-pattern-13" class="form-element check" @if(session()->has('quiz_3') && isset(session('quiz_3')['desen']) && in_array('desen13', session('quiz_3')['desen'])) checked @endif name="quiz[desen][]" type="checkbox" value="desen13"/>
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingTshirt-basic" @if(session()->has('quiz_3') && isset(session('quiz_3')['tshirt']) && in_array('croptop', session('quiz_3')['tshirt'])) checked @endif class="form-element check" name="quiz[tshirt][]" value="croptop" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingTshirt-pattern" @if(session()->has('quiz_3') && isset(session('quiz_3')['tshirt']) && in_array('oversize', session('quiz_3')['tshirt'])) checked @endif  class="form-element check" name="quiz[tshirt][]" value="oversize" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="expressingTshirt-hoodies" @if(session()->has('quiz_3') && isset(session('quiz_3')['tshirt']) && in_array('straight', session('quiz_3')['tshirt'])) checked @endif  class="form-element check" name="quiz[tshirt][]" value="straight" type="checkbox" />
                  ...
                  <div class="rows">
                    <div class="field-wrapper body-type">
                      <div class="row">
                        <div class="column width-4">
                          <div class="hide-check">
                            <input id="prefer-pants-regular" @if(session()->has('quiz_3') && isset(session('quiz_3')['pantolon']) && in_array('clutte', session('quiz_3')['pantolon'])) checked @endif  class="form-element check" name="quiz[pantolon][]" value="clutte" type="checkbox" />
                        ...
                        <div class="column width-4">
                          <div class="hide-check">
                            <input id="prefer-pants-strech" @if(session()->has('quiz_3')  && isset(session('quiz_3')['pantolon']) && in_array('wideleg', session('quiz_3')['pantolon'])) checked @endif class="form-element check" name="quiz[pantolon][]" value="wideleg" type="checkbox" />
                        ...
                        <div class="column width-4">
                          <div class="hide-check">
                            <input id="prefer-pants-straight" @if(session()->has('quiz_3')  && isset(session('quiz_3')['pantolon']) && in_array('carrotleg', session('quiz_3')['pantolon'])) checked @endif class="form-element check" name="quiz[pantolon][]" value="carrotleg" type="checkbox" />
                        ...
                        <div class="column width-4">
                          <div class="hide-check">
                            <input id="prefer-pants-slim"  @if(session()->has('quiz_3')  && isset(session('quiz_3')['pantolon']) && in_array('straight', session('quiz_3')['pantolon'])) checked @endif class="form-element check" name="quiz[pantolon][]" value="straight" type="checkbox" />
                        ...
                        <div class="column width-4">
                          <div class="hide-check">
                            <input id="prefer-pants-skinny" @if(session()->has('quiz_3')  && isset(session('quiz_3')['pantolon']) && in_array('skinny', session('quiz_3')['pantolon'])) checked @endif  class="form-element check" name="quiz[pantolon][]" value="skinny" type="checkbox" />
                        ...
                        <div class="column width-4">
                          <div class="hide-check">
                            <input id="prefer-pants-tayt" @if(session()->has('quiz_3')  && isset(session('quiz_3')['pantolon']) && in_array('tayt', session('quiz_3')['pantolon'])) checked @endif class="form-element check" name="quiz[pantolon][]" value="tayt" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-skirt-1" class="form-element check" @if(session()->has('quiz_3')  && isset(session('quiz_3')['etek']) && in_array('mini', session('quiz_3')['etek'])) checked @endif name="quiz[etek][]" value="mini" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-skirt-2" class="form-element check" @if(session()->has('quiz_3') && isset(session('quiz_3')['etek']) && in_array('midi', session('quiz_3')['etek'])) checked @endif name="quiz[etek][]" value="midi" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-skirt-3" @if(session()->has('quiz_3') && isset(session('quiz_3')['etek']) && in_array('flared', session('quiz_3')['etek'])) checked @endif class="form-element check" name="quiz[etek][]" value="flared" type="checkbox" />
                        ...
                        <div class="column width-4">
													<div class="hide-check">
														<input id="prefer-skirt-4" @if(session()->has('quiz_3') && isset(session('quiz_3')['etek']) && in_array('pencil', session('quiz_3')['etek'])) checked @endif class="form-element check" name="quiz[etek][]" value="pencil" type="checkbox" />
                        ...
                        <div class="column width-4">
													<div class="hide-check">
														<input id="prefer-skirt-5" @if(session()->has('quiz_3') && isset(session('quiz_3')['etek']) && in_array('maxi', session('quiz_3')['etek'])) checked @endif class="form-element check" name="quiz[etek][]" value="maxi" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-sweater-bogazli" class="form-element check" @if(session()->has('quiz_3') && isset(session('quiz_3')['kazak']) && in_array('balikci_yaka', session('quiz_3')['kazak'])) checked @endif name="quiz[kazak][]" value="balikci_yaka" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-sweater-sifir-yaka" @if(session()->has('quiz_3') && isset(session('quiz_3')['kazak']) && in_array('oversized', session('quiz_3')['kazak'])) checked @endif  class="form-element check" name="quiz[kazak][]" value="oversized" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-sweater-v-yaka"  @if(session()->has('quiz_3') && isset(session('quiz_3')['kazak']) && in_array('croptop', session('quiz_3')['kazak'])) checked @endif class="form-element check" name="quiz[kazak][]" value="croptop" type="checkbox" />
                       							 ...
                       							 <div class="column width-4">
													<div class="hide-check">
														<input id="prefer-sweater-hirka" @if(session()->has('quiz_3') && isset(session('quiz_3')['kazak']) && in_array('hirka', session('quiz_3')['kazak'])) checked @endif class="form-element check" name="quiz[kazak][]" value="hirka" type="checkbox" />
												...
												<div class="column width-4">
													<div class="hide-check">
														<input id="prefer-sweater-y-yaka" @if(session()->has('quiz_3') && isset(session('quiz_3')['kazak']) && in_array('yuvarlakyaka', session('quiz_3')['kazak'])) checked @endif class="form-element check" name="quiz[kazak][]" value="yuvarlakyaka" type="checkbox" />
									...
									<div class="rows">
										<div class="field-wrapper body-type">
											<div class="row">
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-yargici" @if(session()->has('quiz_3') && isset(session('quiz_3')['brand']) && in_array('yargici', session('quiz_3')['brand'])) checked @endif class="form-element check" name="quiz[brand][]" value="yargici" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-stefanel" @if(session()->has('quiz_3') && isset(session('quiz_3')['brand']) && in_array('stefanel', session('quiz_3')['brand'])) checked @endif class="form-element check" name="quiz[brand][]" value="stefanel" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-nike" @if(session()->has('quiz_3') && isset(session('quiz_3')['brand']) && in_array('nike', session('quiz_3')['brand'])) checked @endif class="form-element check" name="quiz[brand][]" value="nike" type="checkbox" />
												...
												<div class="column width-2">
													<div class="hide-check">
														<input id="prefer-brand-adl" @if(session()->has('quiz_3') && isset(session('quiz_3')['brand']) && in_array('adl', session('quiz_3')['brand'])) checked @endif class="form-element check" name="quiz[brand][]" value="adl" type="checkbox" />
