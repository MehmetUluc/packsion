									...
									<div class="add-to-link">
										<div class="add-to-link">
											  <div class="quickview-button">
											    <a href="/products/product/ajax/{{ $product->products_id }}" id="work-dresses" data-toggle="tooltip" data-placement="top" title="Quick View" class="sca-qv-button harman_btn3 item-quick-view" data-lightbox="ajax">
