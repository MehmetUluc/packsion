...
@section('content')
  @php
    ...
    } elseif(request()->segment(2) == 'erkek') {
      $gender = 'man';
  ...
  <div class="content clearfix">
  				...
  				<div class="section-block pt-30">
  					<div class="row">
  									...
  									<div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700">
  										<a class="overlay-link no-page-fade" href="javascript:;">
  											...
  											<div class="overlay-info">
  												...
  												<ul>
                            <li class="mobile"><strong>Stil formunuzu doldurun.</strong></li>
                            <li class="mobile"><strong>Kutunuzu ve abonelik sürenizi seçin. Tek seferlik de deneyebilirisiniz.</strong></li>
                          ...
                          <strong style="color:black; margin-top: -20px; margin-bottom: 10px;" class="desktop">Stil formunuzu doldurduktan sonra kutu ve abonelik sürenizi seçin. Stil danışmanlarınızın hazırladığı kombinleri ev konforunda deneyin</strong>
                          @if(Helper::countOfQuiz() > 0)
                            <button class="button bkg-white all-caps" onclick="javascript:window.location.href='/start_quiz?&cache=flush'; return false;"><strong>SİPARİŞ VER</strong></button>
                          @else
    												<button class="button bkg-white all-caps" @if($gender == '') onclick="javascript:window.location.href='/start_quiz?cache=flush'; return false;" @else onclick="javascript:window.location.href='/checkout/quiz/step/1?gender={{ $gender }}&cache=flush'; return false;"@endif ><strong>STİL FORMUNA GİT</strong></button>
                          @endif
                ...
                <div class="single-product full-width pull-left">
                      ...
                      @foreach($images as $image)
    										<div class="column width-3 {{ $image->gender }}">
    											<div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="500" data-hover-bkg-color="#ffffff" data-hover-bkg-opacity="0.8">
    												<a class="overlay-link lightbox-link" data-group="" data-caption="" data-image-url="//packsion.com/{{ $image->image  }}" href="//packsion.com/{{ $image->image  }}" data-lightbox-animation="fadeIn">
    													<img src="//packsion.com/{{ $image->image  }}" alt="" style="transition-duration: 500ms;">
