          ...
          <div class="column width-7 push-1">
            ...
            <div class="row">
              <div class="column width-12">
                <div class="address">
                  <div class="row">
                     @if(isset($shipments[0]['meta']) && count($shipments[0]['meta']) > 0)

                    <div class="column width-12">


                          <div class="single-product full-width pull-left">
                            @foreach($shipments[0]['meta'] as $order)
                            <article>
                              <div class="row">
                                <div class="column width-3">
                                  <div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="500" data-hover-bkg-color="#ffffff" data-hover-bkg-opacity="0.8">
                                    <a class="overlay-link lightbox-link" data-caption="{{ $order->products_name }}" data-image-url="//packsion.com/{{ $order->products_image }}" href="//packsion.com/{{ $order->products_image }}" data-lightbox-animation="fadeIn">
                                      <img src="//packsion.com/{{ $order->products_image }}" alt=""/>
                                ...
                                <div class="column width-5">
                                  <h4 class="all-caps fw-700 mb-10">{{ $order->products_name }}</h4>
                                  <p>Fiyat : {{ $order->shipment_price }}</p>
                                ...
                                <div class="column width-4">
                                  @if($order->status == 1)
                                    ...
                                    <a id="cancel_link" data-content="inline" data-aux-classes="remove-modal" data-toolbar="" data-modal-mode data-modal-width="600" data-lightbox-animation="fadeIn" data-id="{{$order->id}}" href="#remove-modal" class="lightbox-link button small cancel bkg-charcoal bkg-hover-theme color-white color-hover-white mt-30 all-caps fw-700">İade Et</a>
                                  @else
                                    <a class="button small bkg-charcoal bkg-hover-theme color-white color-hover-white mt-30 all-caps fw-700" href="/apply/product/{{ $order->id }}">Aktif Et</a>
                                  @endif
                                </div>
                              </div>
                            </article>
