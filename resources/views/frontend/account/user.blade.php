 			...
 			<div class="content clearfix">
 				...
 				<div class="section-block hero-5 hero-5-2 height-auto min-height-half bkg-grey-ultralight mobile-bkg-white">
 					...
 					<div class="row">
 						<div class="column width-4 half-padding-right left-side-menu mb-60 center">
 							<div class="profile">
 								<div class="img" style="background-image:url({{Auth::guard('customer')->user()->customers_picture}})"></div>
 								<div class="content">
                ...
                <li class=""><a href="/account/quiz" class="button large bkg-hover-black color-hover-white">Kayıtlı Formlarım</a></li>
 						...
 						<div class="column width-7 push-1">
                            ...
                            <option @if($user['customers_gender'] == 'Kadın') selected @endif value="Kadın">Kadın</option>
                        <option @if($user['customers_gender'] == 'Erkek') selected @endif value="Erkek">Erkek</option>
 													</select>
 												</div>
 											</div>
 											<div class="column width-12">
 												<div class="field-wrapper">
 													<input type="text" name="customers_firstname" value="{{ $user['customers_firstname'] }}" class="form-fname form-element large" placeholder="Ad" tabindex="2">
 												</div>
 											</div>
 											<div class="column width-12">
 												<div class="field-wrapper">
 													<input type="text" name="customers_lastname" value="{{ $user['customers_lastname'] }}" class="form-lname form-element large" placeholder="Soyad" tabindex="3">
 												</div>
 											</div>
 											<div class="column width-12">
 												<div class="field-wrapper">
 													<input type="email" name="customers_email_address" value="{{ $user['customers_email_address'] }}" class="form-email form-element large" placeholder="E-Posta adresi" tabindex="4">
 												</div>
 											</div>
