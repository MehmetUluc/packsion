                       ...
                       <div class="column width-12">
                         <article>
                           <div class="v-align-middle">
                             ...
                             <a data-content="inline" data-aux-classes="remove-modal" data-toolbar="" data-modal-mode data-modal-width="600" data-lightbox-animation="fadeIn" data-id={{ $item->id }} href="#remove-modal" class="lightbox-link button small remove"><span class="icon-cross"></span></a>
                             <div class="field-wrapper pull-left">
                               <input onchange="address.add({{ $item->id }})" @if($item->default == 1) checked @endif id="default-address-{{ $item->id }}" value="{{ $item->id }}" class="form-element checkbox" name="default-address" type="checkbox">
                               <label for="default-address-{{ $item->id }}" data-id="{{ $item->id }}" class="checkbox-label">Varsayılan form olarak işaretle</label>
                             </div>
                             <div class="pull-right">
                               <a href="/account/quiz/{{ $item->id }}/step/1" class=""><img src="/assets/images/icon/edit.svg" /> Düzenle</a>
                             </div>
                           </div>
                         </article>
                       </div>
