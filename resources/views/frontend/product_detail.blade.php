  				...
  				<div class="section-block pt-30">
  					<div class="row">
                          ...
                          @if(Helper::countOfQuiz() > 0)
                            <button class="button bkg-white all-caps" onclick="javascript:window.location.href='/start_quiz?product={{ $product->products_id }}&cache=flush'; return false;"><strong>SİPARİŞ VER</strong></button>
                          @else
    												<button class="button bkg-white all-caps" @if(request('gender') == '') onclick="javascript:window.location.href='/start_quiz?product={{ $product->products_id }}&cache=flush'; return false;" @else onclick="javascript:window.location.href='/checkout/quiz/step/1?product_id={{ $product->products_id }}&gender={{ $gender }}&cache=flush'; return false;"@endif ><strong>STİL FORMUNA GİT</strong></button>
                          @endif
