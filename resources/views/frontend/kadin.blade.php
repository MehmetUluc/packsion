...
<section id="how-it-works" class="u-posRelative timeline-container" data-behavior="HowItWorks">
  <div class="u-container u-marginAuto u-textCenter">
    ...
    <a href="/checkout/quiz/step/1?gender=woman&cache=flush" class="Button--rounded u-md-hide js-onboarding-cta" data-section="How it works">{{ @trans('woman.get_started') }}</a>
  </div>
</section>
...
<section id="pricing" class="u-posRelative" data-behavior="TrunkPricing" style="background-image: url(/assets/kadin6.jpg); background-color:#00273D;">
    ...
    <div class="Grid-cell u-md-size1of2 u-textCenter">
      ...
      <a href="/checkout/quiz/step/1?gender=woman&cache=flush" class="Button--rounded u-marginTm js-onboarding-cta" data-section="Pricing">{{ @trans('woman.get_started') }}</a>
    </div>
  </div>
</section>
...
<section id="outfits" class="u-posRelative timeline-container u-bg-color--offWhite">
  <div class="u-container u-marginAuto u-textCenter">
    ...
    <a href="/checkout/quiz/step/1?gender=woman&cache=flush" class="button--rounded u-marginTxl u-md-hide js-onboarding-cta" data-section="Pricing">{{ @trans('man.get_started') }}</a>
  </div>
</section>
...
<section id="trunks" class="u-posRelative" data-behavior="TrunkCheckboxes" style="background-image: url(https://res.cloudinary.com/trunk-club/image/upload/f_auto,q_auto/v1540832135/public_site/2018/holiday/tc-womens-trunks-bg.jpg); background-color:#00273D;">
    ...
    <div class="Grid-cell u-md-size1of2 u-textCenter">
      ...
      <a href="/checkout/quiz/step/1?gender=woman&cache=flush" class="Button--rounded u-marginTm js-onboarding-cta" data-section="Pricing">{{ @trans('man.get_started') }}</a>
    </div>
  </div>
</section>
