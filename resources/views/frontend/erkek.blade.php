...
<section id="how-it-works" class="u-posRelative timeline-container" data-behavior="HowItWorks">
  <div class="u-container u-marginAuto u-textCenter">
    <div class="u-md-size2of3 u-marginAuto">
      <h2 class="u-marginBs">{{ @trans('man.how_works') }}</h2>
      <h4 class="u-textSans">{{ @trans('man.getting_your_first') }}</h4>
    </div>
    ...
    <div class="u-marginTxl u-paddingTm u-posRelative">
      ...
      <div class="how-it-works-video-placeholder">
        <div class="how-it-works-inner u-textCenter u-vertCenter">
          ...
          <p class="u-textSans">{{ @trans('man.see') }}</p>
      ...
      <ol class="timeline Grid u-md-sizeFull u-sm-size3of4 u-marginAuto">
        ...
        <li class="Grid-cell timeline-module u-md-size1of2 u-posRelative">
          <div class="u-boxShadow">
            ...
            <div class="timeline-module__content u-textCenter u-paddingAl u-bg-color--white">
              <p class="u-fontWeight--bold">{{ @trans('man.create_style') }}</p>
              <span class="u-block u-marginTs u-marginBm u-divider"></span>
              <p>
                <span class="u-md-hide">{{ @trans('man.by_answering') }}!</span>
                <span class="u-md-show">{{ @trans('man.where_you_shop') }}.</span>
              </p>
            </div>
          </div>
        </li>
        ...
        <li class="Grid-cell timeline-module u-md-size1of2 u-posRelative">
          <div class="u-boxShadow">
            ...
            <div class="timeline-module__content u-textCenter u-paddingAl u-bg-color--white">
              <p class="u-fontWeight--bold">{{ @trans('man.chat_with_stylist') }}</p>
              <span class="u-block u-marginTs u-marginBm u-divider"></span>
              <p>
                <span class="u-md-hide">{{ @trans('man.youll_talk_to') }}</span>
                <span class="u-md-show">{{ @trans('man.yes_a_real') }}</span>
              </p>
            </div>
          </div>
        </li>
        ...
        <li class="Grid-cell timeline-module u-md-size1of2 u-posRelative">
          <div class="u-boxShadow">
            ...
            <div class="timeline-module__content u-textCenter u-paddingAl u-bg-color--white">
              <p class="u-fontWeight--bold">{{ @trans('man.review_trunk') }}</p>
              <span class="u-block u-marginTs u-marginBm u-divider"></span>
              <p>
                <span class="u-md-hide">{{ @trans('man.youll_have_48') }}.</span>
                <span class="u-md-show">{{ @trans('man.once_you_approve') }}</span>
              </p>
            </div>
          </div>
        </li>
        ...
        <li class="Grid-cell timeline-module u-md-size1of2 u-posRelative">
          <div class="u-boxShadow">
            ...
            <div class="timeline-module__content u-textCenter u-paddingAl u-bg-color--white">
              <p class="u-fontWeight--bold">{{ @trans('man.try_everything') }}</p>
              <span class="u-block u-marginTs u-marginBm u-divider"></span>
              <p>
                <span class="u-md-hide">{{ @trans('man.take_5_days') }}</span>
                <span class="u-md-show">{{ @trans('man.to_decide') }}</span>
              </p>
            </div>
          </div>
        </li>
        ...
        <li class="Grid-cell timeline-module u-md-size1of2 u-posRelative">
          <div class="u-boxShadow">
            ...
            <div class="timeline-module__content u-textCenter u-paddingAl u-bg-color--white">
              <p class="u-fontWeight--bold">{{ @trans('man.reorder') }}</p>
              <span class="u-block u-marginTs u-marginBm u-divider"></span>
              <p>
                <span class="u-md-hide">{{ @trans('man.our_service') }}</span>
                <span class="u-md-show">{{ @trans('man.works_on_your_terms') }}.</span>
              </p>
            </div>
          </div>
        </li>
    ...
    <a href="/checkout/quiz/step/1?gender=man&cache=flush" class="Button--rounded u-md-hide js-onboarding-cta" data-section="How it works">{{ @trans('man.get_started') }}</a>
  </div>
</section>
...
<section id="pricing" class="u-posRelative" data-behavior="TrunkPricing" style="background-image: url(/assets/erkek6.jpg); background-color:#00273D;">
    ...
    <div class="Grid-cell u-md-size1of2 u-textCenter">
      <h2 class="u-marginBm">{{ @trans('man.what_is_cost') }}</h2>
      ...
      <a href="/checkout/quiz/step/1?gender=man&cache=flush" class="Button--rounded u-marginTm js-onboarding-cta" data-section="Pricing">{{ @trans('man.get_started') }}</a>
    </div>
  </div>
</section>
...
<section id="outfits" class="u-posRelative timeline-container u-bg-color--offWhite">
  <div class="u-container u-marginAuto u-textCenter">
    <div class="u-md-size2of3 u-marginAuto">
      <h2 class="u-color--grayDark u-marginBm">{{ @trans('man.styles_can_send') }}</h2>
      <h4 class="u-textSans u-color--grayDark u-marginBm u-marginAuto">{{ @trans('man.your_stylist_get') }}</h4>
    </div>
    ...
    <a href="/checkout/quiz/step/1?gender=man&cache=flush" class="button--rounded u-marginTxl u-md-hide js-onboarding-cta" data-section="Pricing">{{ @trans('man.get_started') }}</a>
  </div>
</section>
...
<section id="trunks" class="u-posRelative" data-behavior="TrunkCheckboxes" style="background-image: url(https://res.cloudinary.com/trunk-club/image/upload/f_auto,q_auto/v1541450979/public_site/2018/holiday/tcm-what-to-expect-bg.jpg); background-color:#00273D;">
    <div class="u-container u-marginAuto Grid u-posRelative">
    <div class="Grid-cell u-md-size1of2 u-textCenter">
      <h2 class="u-marginBm">{{ @trans('man.what_else') }}</h2>
      <span class="u-block u-divider u-marginTs u-marginBm"></span>
      <p class="u-marginBl">{{ @trans('man.every_trunk') }}</p>
      ...
      <div class="u-textLeft">
        <div class="line-item u-flex u-flex--alignCenter u-paddingVs">
          <div class="checkbox u-posRelative u-inlineBlock u-marginLs u-marginRm">
            <svg class="checkbox__check u-posAbsolute is-inview is-inview is-inview is-inview is-inview is-inview is-inview is-inview" width="13px" height="11px" viewBox="0 0 21 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>{{ @trans('man.checkmark') }}</title>
        ...
        <div class="line-item u-flex u-flex--alignCenter u-paddingVs">
          ...
          <p>{{ @trans('man.approving_trunks') }}</p>
        </div>
        <div class="line-item u-flex u-flex--alignCenter u-paddingVs">
          <div class="checkbox u-posRelative u-inlineBlock u-marginLs u-marginRm">
            <svg class="checkbox__check u-posAbsolute is-inview is-inview is-inview is-inview is-inview is-inview is-inview is-inview" width="13px" height="11px" viewBox="0 0 21 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="line-item u-flex u-flex--alignCenter u-paddingVs">
          ...
          <p>{{ @trans('man.options_to_schedule') }}s</p>
        </div>
        <div class="line-item u-flex u-flex--alignCenter u-paddingVs">
          <div class="checkbox u-posRelative u-inlineBlock u-marginLs u-marginRm">
            <svg class="checkbox__check u-posAbsolute is-inview is-inview is-inview is-inview is-inview is-inview is-inview is-inview" width="13px" height="11px" viewBox="0 0 21 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <p>{{ @trans('man.alterations_for_trunk') }}</p>
        </div>
