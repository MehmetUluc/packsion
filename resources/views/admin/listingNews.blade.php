                   ...
                   @if(count($news)>0)
                    @foreach ($news as  $key=>$new)
                        ...
                        <tr>
                            ...
                            <td>
                                <a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Yes') }}Edit" href="editNews/{{ $new->news_id }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                                
                                <a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Yes') }}Delete" id="deleteNewsId" news_id="{{ $new->news_id }}" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    @endforeach
                   @else
