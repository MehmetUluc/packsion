                 ...
                 <div class="col-sm-10 col-md-4">
                   <input type="file" name="file" class="form-control">
                            ...
                            <?php $i = 0; $j = 0;?>
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('Alt İsim') }} ({{ $languages->name }})</label>
                                    <div class="col-sm-10 col-md-4">
                                        <input type="text" name="subname_<?=$languages->languages_id?>" class="form-control field-validate" @if(!empty($result['editPage'][$j]->language_id)) value="{{ $result['editPage'][$i]->subname }}" @endif>
                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.PageName') }} ({{ $languages->name }})</span>
