...
<div class="login-box">
  <div class="login-logo">
   	<img src="{{asset('/resources/views/admin/images/admin_logo/logo.png')}}" style="width:200px;" class="ionic-hide"> 
   	<img src="{{asset('/resources/views/admin/images/admin_logo/logo.png')}}" style="width:200px;" class="android-hide"> 
    <div style="
    font-size: 25px;
