                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                          ...
                          @endif
                            ...
                            <form method="post" action="/admin/influencers/{{$influencer->id}}" class="form-horizontal form-validate" enctype="multipart/form-data">
                              {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                      		<input type="text" name="name" class="form-control field-validate" value="{{ $influencer->name }}">
                                      </div>
                                </div>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                      		<textarea type="text" name="bio" class="form-control field-validate">{{ $influencer->bio }}</textarea>
                                      </div>
                                </div>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                      		<input type="text" name="video" placeholder="Youtube Linki Ekleyin" value="{{ $influencer->video }}" class="form-control field-validate">
                                      </div>
                                </div>
