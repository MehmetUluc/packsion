...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> Blog Düzenle <small>Blog Düzenle...</small> </h1>
    <ol class="breadcrumb">
       <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
      <li><a href="{{ URL::to('admin/listingNews')}}"><i class="fa fa-dashboard"></i> Tüm Bloglar</a></li>
      <li class="active">Blog Düzenle</li>
    </ol>
  </section>
                          ...
                          @endif
                            ...
                            {!! Form::open(array('url' =>'admin/updateNews', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">Kategori</label>
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control field-validate" id="category_id" name="category_id">
     	                               ...
     	                               <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Kategori Seç</span>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control" name="is_feature">
                                          <option value="1" @if($result['news'][0]->is_feature==1) selected @endif >{{ trans('Evet') }}</option>
                                          <option value="0" @if($result['news'][0]->is_feature==0) selected @endif>{{ trans('Hayır') }}</option>
                                      </select>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control" name="news_status">
                                          <option value="1" @if($result['news'][0]->news_status==1) selected @endif >{{ trans('Aktif') }}</option>
                                          <option value="0" @if($result['news'][0]->news_status==0) selected @endif>{{ trans('Pasif') }}</option>
                                      </select>
                              ...
                              <div class="box-footer text-center">
                                <button type="submit" class="btn btn-primary">{{ trans('Güncelle') }}</button>
                                <a href="{{ URL::to('admin/listingNews')}}" type="button" class="btn btn-default">{{ trans('Geri') }}</a>
                              </div>
