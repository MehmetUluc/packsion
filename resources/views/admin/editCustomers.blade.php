            ...
            <div class="row">
              <div class="col-xs-12">
              		<div class="box box-info">
                        <div class="box-header">
              <a class="btn btn-success" href="/admin/{{ request()->segment(2) . '/' . request()->segment(3) }}">Form</a>
              <a class="btn btn-info" href="/admin/{{ request()->segment(2) . '/' . request()->segment(3) . '/boxes' }}">Paketler</a>
            </div>
                        <br>                       
                         ...
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/updateCustomers', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                   {!! Form::hidden('old_email_address',  $data['customers'][0]->customers_email_address, array('class'=>'form-control', 'id'=>'old_email_address')) !!}
                                    {!! Form::email('customers_email_address',  $data['customers'][0]->customers_email_address, array('class'=>'form-control email-validate', 'id'=>'customers_email_address')) !!}
                               ...
                               <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="password" name="customers_password" value="{{ $data['customers'][0]->customers_password }}" class="form-control field-validate" id="customers_password"> 
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="../listingCustomers" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                              </div>
                              <!-- /.box-footer -->
                            {!! Form::close() !!}
                        </div>
