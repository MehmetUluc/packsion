                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control" id="gender" name="gender">
                                         <option value="">{{ 'Seçiniz' }}</option>
                                           ...
                                           <option @if($result['product'][0]->gender == 'Erkek') selected @endif value="Erkek">Erkek</option>
                                           <option @if($result['product'][0]->gender == 'Kadın') selected @endif value="Kadın">Kadın</option>
