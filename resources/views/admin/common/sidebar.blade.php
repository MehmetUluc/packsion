      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview {{ Request::is('admin/listingPages') ? 'active' : '' }}  {{ Request::is('admin/addPage') ? 'active' : '' }}  {{ Request::is('admin/editPage/*') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/listingPages')}}">
            <i class="fa fa-file-text" aria-hidden="true"></i> <span>{{ trans('Sayfalar') }}</span>
          </a>
        </li>

        <li class="treeview {{ Request::is('admin/listingFaq') ? 'active' : '' }}  {{ Request::is('admin/addFaq') ? 'active' : '' }}  {{ Request::is('admin/editFaq/*') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/listingFaq')}}">
            <i class="fa fa-file-text" aria-hidden="true"></i> <span>{{ trans('Sık Sorulan Sorular') }}</span>
          </a>
        </li>
        ...
        <li class="treeview {{ Request::is('admin/slideshows') ? 'active' : '' }}  {{ Request::is('admin/slideshows') ? 'active' : '' }}  {{ Request::is('admin/slideshows/*') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/slideshows')}}" ><i class="fa fa-list-ul" aria-hidden="true"></i> <span> Slideshows</span>
          </a>
        </li>
...
<span>{{ trans('labels.link_categories') }} </span> <i class="fa fa-angle-left pull-right"></i>
        ...
        @endif
         <li class="treeview {{ Request::is('admin/editors') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/editors')}}">
        ...
        <li class="treeview {{ Request::is('admin/listingProducts') ? 'active' : '' }} {{ Request::is('admin/addProduct') ? 'active' : '' }} {{ Request::is('admin/editAttributes/*') ? 'active' : '' }} {{ Request::is('admin/listingAttributes') ? 'active' : '' }}  {{ Request::is('admin/addAttributes') ? 'active' : '' }}  {{ Request::is('admin/editAttributes/*') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
             @if(Auth::user()->type != 'editor')
            <li class="{{ Request::is('admin/influencers') ? 'active' : '' }} {{ Request::is('admin/influencers/add') ? 'active' : '' }} {{ Request::is('admin/influencers/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/influencers')}}"><i class="fa fa-circle-o"></i> Influencers</a></li>
            @endif
...
<span>{{ trans('labels.link_notifications') }}</span> <i class="fa fa-angle-left pull-right"></i>
        ...
        <li class="treeview {{ Request::is('admin/listingShipments') ? 'active' : '' }}  {{ Request::is('admin/addOrders') ? 'active' : '' }}  {{ Request::is('admin/viewShipment/*') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/listingShipments')}}" ><i class="fa fa-list-ul" aria-hidden="true"></i> <span> Shipments</span>
          </a>
        </li>
...
<span> {{ trans('labels.link_site_settings') }}</span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('admin/invoice') ? 'active' : '' }}"><a href="{{ URL::to('admin/invoice')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.invoice_link') }}</a></li>
          </ul>
        </li>
