...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> {{ trans('labels.Influencer') }} <small>{{ trans('labels.Slideshow') }}...</small> </h1>
    <ol class="breadcrumb">
                        ...
                        <!-- form start -->
                         <div class="box-body">
                          ...
                          @endif
                            ...
                            <form method="post" action="/admin/slideshows/{{$influencer->id}}" class="form-horizontal form-validate" enctype="multipart/form-data">
                              {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                      		<input type="text" name="name" class="form-control field-validate" value="{{ $influencer->title }}">
                                      </div>
                                </div>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                      		<textarea type="text" name="top_label" class="form-control">{{ $influencer->top_label }}</textarea>
                                      </div>
                                </div>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                            ...
                                            <option @if($influencer->text == 0) selected @endif value="0">Hayır</option>
                                            <option @if($influencer->text == 1) selected @endif value="1">Evet</option>
                                          </select>
                                      </div>
                                </div>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                            ...
                                            <option @if($influencer->buttons == 0) selected @endif value="0">Hayır</option>
                                            <option @if($influencer->buttons == 1) selected @endif value="1">Evet</option>
                                          </select>
                                      </div>
                                </div>
                                ...
                                <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">Masaüstü Resim</label>
                                  <div class="col-sm-10 col-md-4">
