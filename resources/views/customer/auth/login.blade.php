                                ...
                                <div class="row">
                                    <div class="column width-6 center-padding-right">
                                        <form class="sign-up-form" action="/customer/register" method="post" novalidate>
                                            ...
                                            <div class="row">
                                                <div class="column width-12">
                                                    <input type="text" name="customers_firstname" class="form-fname form-element large" placeholder="İsim" value="{{ old('customers_firstname') }}" tabindex="1" required>
                                                </div>
                                                <div class="column width-12">
                                                    <input type="text" name="customers_lastname" value="{{ old('customers_lastname') }}" class="form-lname form-element large" placeholder="Soyisim" tabindex="2">
                                                </div>
                                                <div class="column width-12">
                                                    <input type="email" name="customers_email_address" value="{{ old('customers_email_address') }}" class="form-email form-element large" placeholder="E-Posta Adresi" tabindex="3" required>
                                                </div>
                                                <div class="column width-12">
